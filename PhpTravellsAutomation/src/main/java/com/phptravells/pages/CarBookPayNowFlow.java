...
public class CarBookPayNowFlow {
	...
	public static void carBookingPayNow(String fname, String lname, String cardno, String cvvno,WebDriver driver,FindLocator loc) {
		...
		logge = Logger.getLogger(CarBookPayNowFlow.class); // log4j implementation for storing the result
		...
		car.verify(CarTwoBookingFlow.strdepositnow2, inr_Strdepositnow2, "not matched");// total deposit verification 
		car.verify(CarTwoBookingFlow.strvat2, arrstrvat2, "not matched");// total vat verification 
		car.verify(CarTwoBookingFlow.srtamt2, arrstrtotal2, "not matched");// total amount verification 
		...
		carr.verify(CarFirstBookingPayArrivalFlow.strronecar, strcarmatch1.toUpperCase(), "not correct");
		carr.verify(CarTwoBookingFlow.strrtwocar, strcarmatch2.toUpperCase(), "not correct");
