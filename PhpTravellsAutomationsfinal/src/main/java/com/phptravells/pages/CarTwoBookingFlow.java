...
public class CarTwoBookingFlow {
	 ...
	 */
	public static void CarTwoBooking1(String secsendkeyonpick, String secsenddepartdate, String secsendkeydrop,WebDriver driver,FindLocator loc) throws InterruptedException {
